...
class FundTypeFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $fundType->setFundName('1 centimes');
        ...
        $fundType = new FundType();
        $fundType->setFundName('2 centimes');
        $fundType->setAmount(0.02);
        $this->addReference('FUNDTYPE_'.$fundType->getAmount(), $fundType);
        $manager->persist($fundType);

        $fundType = new FundType();
        $fundType->setFundName('5 centimes');
        $fundType->setAmount(0.05);
        $this->addReference('FUNDTYPE_' . $fundType->getAmount(), $fundType);
        $manager->persist($fundType);

        $fundType = new FundType();
        $fundType->setFundName('10 centimes');
        $fundType->setAmount(0.10);
        $this->addReference('FUNDTYPE_' . $fundType->getAmount(), $fundType);
        $manager->persist($fundType);

        $fundType = new FundType();
        $fundType->setFundName('20 centimes');
        ...
        $fundType = new FundType();
        $fundType->setFundName('50 centimes');
        $fundType->setAmount(0.50);
        $this->addReference('FUNDTYPE_' . $fundType->getAmount(), $fundType);
        $manager->persist($fundType);

        $fundType = new FundType();
        $fundType->setFundName('1 euro');
        $fundType->setAmount(1.00);
        $this->addReference('FUNDTYPE_' . $fundType->getAmount(), $fundType);
        $manager->persist($fundType);

        $fundType = new FundType();
        $fundType->setFundName('2 euros');
        $fundType->setAmount(2.00);
        $this->addReference('FUNDTYPE_' . $fundType->getAmount(), $fundType);
        $manager->persist($fundType);

        $fundType = new FundType();
        $fundType->setFundName('5 euros');
        $fundType->setAmount(5.00);
        $this->addReference('FUNDTYPE_' . $fundType->getAmount(), $fundType);
        $manager->persist($fundType);

        $fundType = new FundType();
        $fundType->setFundName('10 euros');
        $fundType->setAmount(10.00);
        $this->addReference('FUNDTYPE_' . $fundType->getAmount(), $fundType);
        $manager->persist($fundType);

        $fundType = new FundType();
        $fundType->setFundName('20 euros');
        $fundType->setAmount(20.00);
        $this->addReference('FUNDTYPE_' . $fundType->getAmount(), $fundType);
        $manager->persist($fundType);

        $fundType = new FundType();
        $fundType->setFundName('50 euros');
        $fundType->setAmount(50.00);
        $this->addReference('FUNDTYPE_' . $fundType->getAmount(), $fundType);
        $manager->persist($fundType);

        $fundType = new FundType();
        $fundType->setFundName('100 euros');
        $fundType->setAmount(100.00);
        $this->addReference('FUNDTYPE_' . $fundType->getAmount(), $fundType);
        $manager->persist($fundType);

        $fundType = new FundType();
        $fundType->setFundName('200 euros');
        $fundType->setAmount(200.00);
        $this->addReference('FUNDTYPE_' . $fundType->getAmount(), $fundType);
        $manager->persist($fundType);

        $fundType = new FundType();
        $fundType->setFundName('500 euros');
