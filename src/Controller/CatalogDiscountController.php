...
use App\Form\CatalogDiscountType;
...
class CatalogDiscountController extends AbstractController
{
    ...
    public function showAll(EntityManagerInterface $entityManager, Request $request): Response
    {
        ...
        return $this->render('catalog_discount/showAll.html.twig', [
            'discounts' => $discounts,
    ...
    public function show(EntityManagerInterface $entityManager, $discountID): Response
    {
        ...
        return $this->render('catalog_discount/show.html.twig', [
            'discount' => $discount,
    ...
    public function new(EntityManagerInterface $entityManager, Request $request): Response
    {
        ...
        return $this->render('catalog_discount/new.html.twig', [
            'discount' => $discount,
    ...
    public function edit(EntityManagerInterface $entityManager, Request $request, $discountID): Response
    {
        ...
        return $this->render('catalog_discount/edit.html.twig', [
            'discount' => $discount,
            'form' => $form->createView(),
